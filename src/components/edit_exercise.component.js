...
export default class EditExercise extends Component{
    ...
    //http://localhost:5000/exercises/edit/61c6049707cafccf013268ac
    ...
    componentDidMount(){
        ...
        axios.get('http://localhost:5000/exercises/'+url_id)//we get the id directly from the url
            .then(response => {
                this.setState({
            ...
            .catch(function(err){
                console.log("edit_exercise/componentDidMount"+err);
            })
    ...
    //http://localhost:5000/exercises/update61c7bf50db5f15f7c47f3759
    ...
    onSubmit(e){
        ...
        axios.post('http://localhost:5000/exercises/update/'+url_id,exercise)
